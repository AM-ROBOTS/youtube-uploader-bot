# [Youtube Uploader Bot](https://tx.me/youtubeitrobot))
...
```bash
$ git clone https://github.com/8769ANURAG/youtube-uploader-bot.git
...
Here's a YouTube tutorial video for deploying the bot on [Heroku](https://heroku.com/ "Heroku"). [Video Link](https://youtu.be/Miajl2amrKo "Tutorial video for deploying to Heroku").

### Contact

You can contact me [@AM_ROBOTS](https://telegram.dog/am_robots "AM_ROBOTS").
